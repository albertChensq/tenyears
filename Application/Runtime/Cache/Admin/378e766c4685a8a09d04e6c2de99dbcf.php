...
<html lang="en">
  ...
  <body>
    <div class="header">
        <h1 class="page-title">发站内信</h1>
    </div>
        <ul class="breadcrumb">
            <li>
              <a href="/tenyears/admin.php/Admin/Email">主页</a>
...
<div class="row-fluid">
  <div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">站内信</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form id="tab" action="/tenyears/admin.php/Admin/email/insert" method="post">
        <label>信息内容</label>
