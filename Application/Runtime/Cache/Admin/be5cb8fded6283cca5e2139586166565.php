...
<html lang="en">
  ...
  <body class=""> 
        <div class="header">
          ...
          <ul class="breadcrumb">
            <li><a href="/tenyears/admin.php/Admin/Revemail">主页</a> <span class="divider">/</span></li>
      ...
      <!-- 搜索分页-->
        ...
        <form class="form-inline form-left" action="/tenyears/admin.php/Admin/Revemail/index" method="get">
...
<div class="well">
    <table class="table ">
      ...
      <tbody>
        <?php if(is_array($revemails)): foreach($revemails as $key=>$vo): ?><tr>
          ...
          <td>
              <a href="javascript:void(0)" class="deluser" role="button"  revemailid="<?php echo ($vo["id"]); ?>"><i class="icon-remove"></i></a>
          </td>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <script src="/tenyears/Public/admin/js/my.revemaildel.js"></script>  
  </body>
</html>