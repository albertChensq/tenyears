...
<html lang="en">
  ...
  <body class=""> 
        <div class="header">
            <h1 class="page-title">梦想</h1>
        </div>
          <ul class="breadcrumb">
            <li><a href="/tenyears/admin.php/Admin/Dreams">主页</a> <span class="divider">/</span></li>
            <li class="active">梦想</li>
        </ul>
      ...
      <!-- 搜索分页-->
        <form class="form-inline form-left" action="/tenyears/admin.php/Admin/Dreams/index" method="get">
            <input name="keywords" class="input-xlarge" placeholder="Search...." id="appendedInputButton" type="text">
...
<div class="well">
    <table class="table ">
      ...
      <tbody>
        <?php if(is_array($dreams)): foreach($dreams as $key=>$vo): ?><tr>
          <td><?php echo ($vo['id']); ?></td>
          <td><?php echo ($vo['uid']); ?></td>
          <td><?php echo ($vo['title']); ?></td>
          <td><?php echo ($vo['dmdesc']); ?></td>
          <td><?php echo (date("Y-m-d",$vo['posttime'])); ?></td>
          <td><?php echo (date("Y-m-d",$vo['deadline'])); ?></td>
          <td><?php echo ($vo['admirenum']); ?></td>
        <!--   <td><?php echo ($vo["commentsnum"]); ?></td> -->
          <td>
              <a href="javascript:void(0)" class="deluser" role="button" dreamsid = "<?php echo ($vo["id"]); ?>"><i class="icon-remove"></i></a>
          </td>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>你确定删除该梦想吗</p>
    </div>
   ...
   <script src="/tenyears/Public/admin/js/my.dreamsdel.js"></script>  
  </body>
</html>