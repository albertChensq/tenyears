...
<html lang="en">
  ...
  <body class=""> 
        <div class="header">
          ...
          <ul class="breadcrumb">
            <li><a href="/tenyears/admin.php/Admin/Tags">主页</a> <span class="divider">/</span></li>
      ...
      <!-- 搜索分页-->
        ...
        <form class="form-inline form-left" action="/tenyears/admin.php/Admin/Tags/index" method="get">
...
<div class="well">
    <table class="table ">
      ...
      <tbody>
        <?php if(is_array($tags)): foreach($tags as $key=>$vo): ?><tr>
          <td><?php echo ($vo['id']); ?></td>
          <td><?php echo ($vo['tagname']); ?></td>
          <td>
              <a href="javascript:void(0)" class="deluser" role="button"  tagsid="<?php echo ($vo["id"]); ?>"><i class="icon-remove"></i></a>
          </td>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <script src="/tenyears/Public/admin/js/my.tagsdel.js"></script>  
  </body>
</html>