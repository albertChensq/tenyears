...
<html lang="en">
  ...
  <body class=""> 
        <div class="header">
          ...
          <ul class="breadcrumb">
            <li><a href="/tenyears/admin.php/Admin/Ideacomments">主页</a> <span class="divider">/</span></li>
            <li class="active">想法评论</li>
        </ul>
      ...
      <!-- 搜索分页-->
        <form class="form-inline form-left" action="/tenyears/admin.php/Admin/Ideacomments/index" method="get">
...
<div class="well">
    <table class="table ">
      ...
      <tbody>
        <?php if(is_array($ideacomments)): foreach($ideacomments as $key=>$vo): ?><tr>
          ...
          <td>
              <a href="javascript:void(0)" class="deluser" role="button"  ideacommentsid="<?php echo ($vo["id"]); ?>"><i class="icon-remove"></i></a>
          </td>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <script src="/tenyears/Public/admin/js/my.ideacommentsdel.js"></script>  
  </body>
</html>