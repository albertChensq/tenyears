...
<html lang="en">
  ...
  <body class=""> 
        <div class="header">
          ...
          <ul class="breadcrumb">
            <li><a href="/tenyears/admin.php/Admin/Email">主页</a> <span class="divider">/</span></li>
      ...
      <!-- 搜索分页-->
        ...
        <form class="form-inline form-left" action="/tenyears/admin.php/Admin/Email/index" method="get">
    ...
    <table class="table ">
      ...
      <tbody>
        <?php if(is_array($messages)): foreach($messages as $key=>$vo): ?><tr>
          ...
          <td>
              <a href="javascript:void(0)" class="deluser" role="button"  messagesid="<?php echo ($vo["id"]); ?>"><i class="icon-remove"></i></a>
          </td>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <script src="/tenyears/Public/admin/js/my.messagesdel.js"></script>  
  </body>
</html>