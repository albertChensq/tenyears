...
<html lang="en">
  ...
  <body class=""> 
        <div class="header">
          ...
          <ul class="breadcrumb">
            <li><a href="/tenyears/admin.php/Admin/Dmideas">主页</a> <span class="divider">/</span></li>
            <li class="active">想法</li>
        </ul>
      ...
      <!-- 搜索分页-->
        <form class="form-inline form-left" action="/tenyears/admin.php/Admin/Dmideas/index" method="get">
...
<div class="well">
    <table class="table ">
      ...
      <tbody>
        <?php if(is_array($dmideas)): foreach($dmideas as $key=>$vo): ?><tr>
         ...
         <!--   <td><?php echo ($v0["commentsnum"]); ?></td> -->
          <td>
              <a href="javascript:void(0)" class="deluser" role="button" dmideasid = "<?php echo ($vo["id"]); ?>"><i class="icon-remove"></i></a>
          </td>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>你确定删除该想法吗</p>
    </div>
   ...
   <script src="/tenyears/Public/admin/js/my.dmideadel.js"></script>  
  </body>
</html>