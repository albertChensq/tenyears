...
<html lang="en">
  ...
  <body class=""> 
        <div class="header">
          ...
          <ul class="breadcrumb">
            <li><a href="/tenyears/admin.php/Admin/Sendemail">主页</a> <span class="divider">/</span></li>
      ...
      <!-- 搜索分页-->
        ...
        <form class="form-inline form-left" action="/tenyears/admin.php/Admin/Sendemail/index" method="get">
...
<div class="well">
    <table class="table ">
      ...
      <tbody>
        <?php if(is_array($sendemails)): foreach($sendemails as $key=>$vo): ?><tr>
          <td><?php echo ($vo['id']); ?></td>
          <td><?php echo ($vo["suid"]); ?></td>
          <td><?php echo ($vo["ruid"]); ?></td> 
          <td><?php echo ($vo["content"]); ?></td>
          <td><?php echo (date("Y-m-d",$vo["posttime"])); ?></td>
          <td>
              <a href="javascript:void(0)" class="deluser" role="button"  sendemailid="<?php echo ($vo["id"]); ?>"><i class="icon-remove"></i></a>
          </td>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>你确定删除此项吗</p>
    </div>
   ...
   <script src="/tenyears/Public/admin/js/my.sendemaildel.js"></script>  
  </body>
</html>